...
if (!empty($_SESSION['panier'])) {
    ...
    foreach ($_SESSION['panier'] as $produit => $quantite) {
        ...
        $requeteProduit = "SELECT * FROM produits_arl WHERE nom = '$produit'";
...
<button type='submit' name='valider_commande' class='btn-buy2' onclick=\"location.href='Validerpanier.php'\">Valider la commande</button>
...
$requete = "SELECT * FROM produits_arl";
...
<footer>
        ...
        <img class="image5" src="img\revuelto.png">
         <img class="image6" src="img\Design sans titre (17).png">
    </footer>
